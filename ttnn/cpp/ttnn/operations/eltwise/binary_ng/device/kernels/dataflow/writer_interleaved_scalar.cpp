...
void kernel_main() {
    ...
    DPRINT << TSLICE(cb_id_src, 0, SliceRange::hw041(), TSLICE_INPUT_CB, TSLICE_RD_PTR, true, true) << ENDL();
    DPRINT << TSLICE(cb_id_src, 1, SliceRange::hw041(), TSLICE_INPUT_CB, TSLICE_RD_PTR, true, true) << ENDL();
